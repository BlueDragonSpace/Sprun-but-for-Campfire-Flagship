...
const PLAYER_TYPE = 'All, Basic, Wizerd, Kitty, Rodent Lord, Rat, Mouse, Hamster, Porcupine, Squirel, Flying Squirel, Beaver, Raccoon, Sigilant, Sigilant ON, Reflected Kitty'
